...
import 'homebookingapp_model.dart';
export 'homebookingapp_model.dart';

class HomebookingappWidget extends StatefulWidget {
  const HomebookingappWidget({super.key});

  @override
  State<HomebookingappWidget> createState() => _HomebookingappWidgetState();
}

class _HomebookingappWidgetState extends State<HomebookingappWidget> {
  late HomebookingappModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomebookingappModel());
